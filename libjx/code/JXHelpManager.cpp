	...
	)
{
	...
	(JXGetSharedPrefsManager())->SetHelpManagerPrefs();
}
...
JFileVersion
JXHelpManager::GetCurrentSetupVersion()
	const
{
...
void
JXHelpManager::WriteLatestSetup
	(
	ostream& output
	)
	const
{
	assert( kCurrentSetupVersion == 4 );
	WriteSetupV4(output);
}
