	...
	JXWidgetSet(enclosure, hSizing, vSizing, x,y, w,h)
{
	...
	itsWildcardInput->ShareEditMenu(te, kJFalse, kJFalse);
	itsRegexInput->ShareEditMenu(te, kJFalse, kJFalse);
...
{
	itsWildcardInput->AppendEditMenu(menuBar, kJFalse, kJFalse, kJFalse, kJFalse);
	itsRegexInput->ShareEditMenu(itsWildcardInput, kJFalse, kJFalse);
